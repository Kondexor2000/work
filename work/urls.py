...
urlpatterns = [
    ...
    path('course/<int:course_id>/subject/<int:subject_id>/', AddSubjectView.as_view(), name='add_subject'),
    path('course/<int:course_id>/subject/<int:subject_id>/test/<int:test_id>/', AddTestView.as_view(), name='add_test'),
    path('course/<int:course_id>/subject/<int:subject_id>/test/<int:test_id>/question/<int:question_id>/', AddQuestionView.as_view(), name='add_question'),
    path('course/<int:course_id>/subject/<int:subject_id>/test/<int:test_id>/question/<int:question_id>/answer/<int:answer_id>', AddAnswersView.as_view(), name='answer_question'),
    path('cv/<int:cv_id>/experience', AddExperienceView.as_view(), name='add_experience'),
    path('portfolio/<int:portfolio_id>/project', AddProjectView.as_view(), name='add_project'),
    path('portfolio/<int:portfolio_id>/link', AddLinkView.as_view(), name='add_link'),
    ...
    path('cv/<int:cv_id>/experience/update', UpdateExperienceView.as_view(), name='update_experience'),
    path('cv/', AddCVView.as_view(), name='add_cv'),
    path('business/<int:business_id>/hr', AddHRView.as_view(), name='add_hr'),
    path('offer_jobs/', AddOfferJobsView.as_view(), name='add_offer_jobs'),
    ...
    path('', accepted_offers_job_user, name='accepted_offers_job_user'),
    path('offers-job/user/', offers_job_user, name='offers_job_user'),
    ...
    path('course/<int:course_id>/subjects/', subject_to_course_view, name='subject_to_course_view'),
    path('course/certificates/', course_to_certificate_view, name='course_to_certificate_view'),
    path('subject/<int:subject_id>/tests/', subject_to_test_view, name='subject_to_test_view'),
    path('test/<int:test_id>/questions/', test_to_question_view, name='test_to_question_view'),
    path('course/<int:id_course>/certificate/', search_stores, name='search_stores'),
    path('user/test-scores/', test_score_to_user_view, name='test_score_to_user_view'),
    ...
    path('portfolio/<int:portfolio_id>/projects/', portfolio_projects_view, name='portfolio_projects_view'),
    ...
    path('portfolio/<int:portfolio_id>/links/', portfolio_links_view, name='portfolio_links_view'),
