...
urlpatterns = [
    ...
    path('course/<int:course_id>/subject/', AddSubjectView.as_view(), name='add_subject'),
    path('course/<int:course_id>/subject/<int:subject_id>/test/', AddTestView.as_view(), name='add_test'),
    path('course/<int:course_id>/subject/<int:subject_id>/test/<int:test_id>/question/', AddQuestionView.as_view(), name='add_question'),
    path('course/<int:course_id>/subject/<int:subject_id>/test/<int:test_id>/question/<int:question_id>/answer/', AddAnswersView.as_view(), name='answer_question'),
