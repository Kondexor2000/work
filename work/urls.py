...
urlpatterns = [
    ...
    path('business/<int:business_id>/offer_jobs/create/', AddOfferJobsView.as_view(), name='add_offer_jobs'),
    ...
    path('business/<int:business_id>/offer_jobs/', offer_jobs_id, name='read_offer_jobs'),
    path('business/<int:business_id>/offer_jobs/<int:offer_id>/', offer_jobs_id_one, name='read_offer_jobs_one'),
